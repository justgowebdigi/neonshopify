...
class VariantSelects extends HTMLElement {
 ...
 updateMedia() {
    ...
    let imgsrc = document.querySelector(`[data-media-id="${this.dataset.section}-${this.currentVariant.featured_media.id}"] img`).getAttribute("src").split("?")[0];
    console.log(imgsrc);
    document.querySelector(".owl-thumbs img[src^='"+imgsrc+"']").parentElement.click();
